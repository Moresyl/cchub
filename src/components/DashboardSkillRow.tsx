...
function DashboardSkillRowComponent({ skill }: DashboardSkillRowProps) {
  return (
    <div className="list-row" style={{ padding: "10px 12px" }}>
      ...
      {skill.trigger_command && (
        <code className="badge badge-accent" style={{ fontFamily: "var(--font-code)", fontSize: 10, flexShrink: 0 }}>
          {skill.trigger_command}
        </code>
      )}
    </div>
