...
function SettingsShortcutCardComponent({ shortcutKey, description }: SettingsShortcutCardProps) {
  return (
    <div style={{ padding: "12px 14px", borderRadius: 10, background: "var(--bg-input)" }}>
      <div style={{ marginBottom: 6 }}>
        <code className="badge badge-accent" style={{ fontFamily: "var(--font-code)" }}>
          {shortcutKey}
        </code>
      </div>
