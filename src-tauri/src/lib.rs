...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::claude_desktop_profiles::get_claude_desktop_providers,
            commands::claude_desktop_profiles::save_claude_desktop_provider,
            commands::claude_desktop_profiles::apply_claude_desktop_provider,
            commands::claude_desktop_profiles::restore_claude_desktop_official,
            commands::claude_desktop_profiles::delete_claude_desktop_provider,
