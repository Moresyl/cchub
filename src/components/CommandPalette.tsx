...
const PAGE_ICONS: Record<string, LucideIcon> = {
  ...
  "/sessions": History,
  "/hermes-memory": Brain,
  "/hermes-providers": Brain,
  "/openclaw": Terminal,
  "/proxy-advanced": ArrowRightLeft,
  "/claude-md": FileText,
  ...
  const pageItems = useMemo<PaletteItem[]>(
    () => [
      ...
      },
      {
        id: "page-usage",
        label: i.nav.usage,
        icon: PAGE_ICONS["/usage"],
        group: pageGroupLabel,
        keywords: ["usage", "analytics", "tokens", "cost"],
        value: `${i.nav.usage} usage analytics tokens cost`,
        action: { type: "navigate", path: "/usage" },
      },
      {
        id: "page-prompts",
        label: i.nav.prompts,
        icon: PAGE_ICONS["/prompts"],
        group: pageGroupLabel,
        keywords: ["prompts", "instructions", "agents"],
        value: `${i.nav.prompts} prompts instructions agents`,
        action: { type: "navigate", path: "/prompts" },
      },
      {
        id: "page-skills",
        label: i.nav.skills,
      ...
      {
        id: "page-hermes-memory",
        label: i.nav.hermesMemory,
        icon: PAGE_ICONS["/hermes-memory"],
        group: pageGroupLabel,
        keywords: ["hermes", "memory"],
        value: `${i.nav.hermesMemory} hermes memory`,
        action: { type: "navigate", path: "/hermes-memory" },
      },
      {
        id: "page-hermes-providers",
        label: i.nav.hermesProviders,
        icon: PAGE_ICONS["/hermes-providers"],
        group: pageGroupLabel,
        keywords: ["hermes", "providers"],
        value: `${i.nav.hermesProviders} hermes providers`,
        action: { type: "navigate", path: "/hermes-providers" },
      },
      {
        id: "page-openclaw",
        label: i.nav.openClaw,
        icon: PAGE_ICONS["/openclaw"],
        group: pageGroupLabel,
        keywords: ["openclaw", "agents"],
        value: `${i.nav.openClaw} openclaw agents`,
        action: { type: "navigate", path: "/openclaw" },
      },
      {
        id: "page-proxy-advanced",
        label: i.nav.proxyAdvanced,
        icon: PAGE_ICONS["/proxy-advanced"],
        group: pageGroupLabel,
        keywords: ["proxy", "optimizer", "failover"],
        value: `${i.nav.proxyAdvanced} proxy optimizer failover`,
        action: { type: "navigate", path: "/proxy-advanced" },
      },
      {
        id: "page-claude-md",
