...
struct LocalProviderProxyRuntimeInner {
    ...
    optimizer_config: Option<crate::proxy_optimizer::OptimizerConfig>,
    rectifier_config: Option<crate::proxy_optimizer::config::RectifierConfig>,
}
